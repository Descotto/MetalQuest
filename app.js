...
//=========================================== BOUNDARIES logic.
const collisionMap = [];
function prepCollision(array, output) {
    for (let z = 0; z < array.length; z += 50) {
        output.push(array.slice(z, 50 + z));
    }
}
prepCollision(collisions, collisionMap);
...
const boundaries = [];
function prepBoundaries(array, output) {
    array.forEach((row, i) => {
...
prepBoundaries(collisionMap, boundaries);
//========================================== LOOT ITEMS ===============================//
